...
const Test = () => {
    ...
    const getUser = () => {
        axios.get('http://rlatkdalbtest1-1182715068.ap-northeast-2.elb.amazonaws.com/users')
            .then(res => {
                setUsers(res.data);
            })
            .catch(err => {
    ...
    const createUser = () => {
        ...
        axios.post('http://rlatkdalbtest1-1182715068.ap-northeast-2.elb.amazonaws.com/users', user)
            .then(res => {
